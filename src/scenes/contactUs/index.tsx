        ...
        <div className="mt-10 justify-between gap-8 md:flex">
          ...
          >
            <form
              target="_blank"
              onSubmit={onSubmit}
              action="https://formsubmit.co/5aa0b58c63ff59af23327a94f4d74f52"
              method="POST"
            >
              <input
              ...
              {errors.messsage && (
                <p className="mt-1 text-primary-500">
                    {errors.messsage.type === "required" && "This field is required."}
                    {errors.messsage.type === "maxLength" && "Max length is 2000 char."}
                </p>
              )}
